...
const UpgradeCards = ({role, plan, desc, amt, f1, f2, f3}) => {
  return (
    <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-gradient-to-b from-amber-100 to-amber-300 text-black border-2 rounded-lg">
      ...
      <button className="bg-gradient-to-br from-orange-400 to-red-400 border-2 border-amber-400 rounded-xl text-white font-semibold text-base tracking-wide  py-2 px-4 hover:bg-gradient-to-tl hover:scale-105 transition-all ease-in-out duration-200 flex justify-center items-center">
        Get started
      </button>
    </div>
  );
