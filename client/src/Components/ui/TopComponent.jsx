  ...
  return (
    <li className="flex justify-center">
      ...
      >
        ...
        <div className="group relative flex w-full max-w-[400px] flex-col overflow-hidden rounded-xl shadow-md hover:shadow-lg bg-gradient-to-t from-amber-300 via-orange-200 to-amber-200 border-t-4 border-slate-700">
          <div className="flex flex-col gap-3 p-5 md:gap-4">
            <div className="flex gap-2">
              ...
              <p className="font-semibold rounded-full bg-grey-500/10 px-4 py-1 bg-orange-500 text-zinc-900">
            ...
            <Link
              to={page}
              className="bg-gradient-to-br from-orange-400 shadow-2xl shadow-red-400 border-2 border-green-500 rounded-xl text-white font-semibold text-base tracking-wide to-red-400 py-2 px-4 hover:bg-gradient-to-tl hover:scale-105 transition-all ease-in-out duration-200 flex justify-center items-center"
            >
              {action === "donate" && (
                <>
