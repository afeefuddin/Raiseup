...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-white via-white to-amber-300 min-h-screen flex flex-col items-center justify-center">
        <div className="bg-gradient-to-t from-orange-200 to-orange-300 p-8 rounded shadow-md w-96">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              disabled={loading}
              className="w-full bg-orange-400 hover:bg-orange-500 duration-75 text-white p-2 rounded"
              type="submit"
            >
              Log In
            </button>
        ...
        <div className="text-center text-slate-800 mt-4">
          Need an account?{" "}
          <Link to="/signup" className="text-pink-800 font-bold tracking-wide">
            Sign Up
          </Link>
        </div>
      </div>
